      ...
      <SafeAreaView style={styles.safearea}>
        {id ? (
          <View style={styles.container}>
           ...
           <Pressable style={styles.shopping_list} onPress={() => router.push("profile/shopping-list")}>
                <Text style={styles.title}>My Shopping List</Text>
                <View style={styles.container_row}>
                    {userInfo?.ingredients?.slice(0, 6).map((item, index) => (
                    <View key={index} style={styles.shopping_item_container}>
                        <Text style={styles.shopping_item}>{item}</Text>
                    </View>
                    ))}
                </View>
            </Pressable>

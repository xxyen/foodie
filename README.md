...
The backend is already deployed on AWS EC2 with the domain name: [https://foodie.zeus.wang/](https://foodie.zeus.wang/). This means you don’t need to run the backend manually unless you want to set it up locally.
...
- **Expo Go**: Scan the QR code generated by npm start to test the app on your mobile device.
### Option 2: Run Frontend and Backend Locally
If you prefer to run the backend locally:

1. Update the frontend configuration:
Replace all instances of https://foodie.zeus.wang/ with localhost in the frontend code.
...
npm run dev
```
3. Start the frontend following the steps in Option 1.
